...
function renderListFav() {
  ...
  for (let i = 0; i < favList.length; i++) {
    ...
    if (favList[i].show.image === null) {
      //si la img no tiene url
      src2 = "../images/no-image.webp";
    } else {
...
// manejar el popup o modal
const btnAbrirJuego = document.getElementById("btnAbrirJuego");
const modalJuego = document.getElementById("modalJuego");
const btnConfirmarJuego = document.getElementById("btnConfirmarJuego");
const closeModal = document.querySelector(".close");

// Mostrar el modal al hacer clic en "Jugar ahora"
...
// Iniciar el juego
btnConfirmarJuego.addEventListener("click", function () {
  modalJuego.classList.add("hidden"); 
  window.open(
    "./game.html",
    "JuegoPiedraPapelTijera",
